...
* will be replaced if magkakaron ng server-side filtering
  */
   ...
   * Socket listeners are set up directly in useEffect to ensure proper cleanup.
   */
  useEffect(() => {
    if (!socketClient) {
    ...
    // Cleanup: remove listeners when component unmounts or socketClient changes
    return () => {
